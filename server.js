...
app.post('/request', function(req, res){
	pg.connect(connString, function(err, client, done){
		if (!err){
			client.query("INSERT INTO requests (info, pickup_location, dropoff_location, time, taken, requester_id, driver_id) VALUES ($1, $2, $3, $4, $5, $6, $7)", [req.body.info, req.body.pickup_location, req.body.dropoff_location, req.body.time, false, 0, null], function(err, result) {
